...
OBJ_FILES+= obj/Affichage.o obj/PropositionAccepte.o obj/Ville.o
...
obj/Affichage.o : src/Affichage.cpp src/Affichage.h src/Ville.cpp
	$(COMPILATIONOBJ)

obj/Ville.o : src/Ville.cpp src/Ville.h src/Parking.cpp src/Voiture.cpp
	$(COMPILATIONOBJ)
